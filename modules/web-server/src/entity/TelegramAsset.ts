...
export class TelegramAsset {
  ...
  // The bot's current status in this asset (e.g., 'creator', 'administrator', 'member', 'restricted', 'left', 'kicked')
  @Column({ type: 'varchar', length: 50, name: 'bot_status', default: 'unknown' })
  botStatus: string;
