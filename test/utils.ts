...
export const USDT_MAINNET_ADDRESS = Address.parse("kQD0GKBM8ZbryVk2aESmzfU6b9b_8era_IkvBSELujFZPsyy");
...
function translateAddress(address: string): AddressFormats {
...
let contractAddress = 'kQAjglu5XraDqkLJyP5dNO5oLPcJw6t3cODQKZE0inxRKzRR';
