...
export async function run(provider: NetworkProvider, args: string[]) {
    ...
    const formattedOutput = {
        ...
        contractUsdtJettonWallet: campaignData.contractUsdtWallet.toString(),
        advertiserFeePercentage: campaignData.advertiserFeePercentage.toString(),
        affiliateFeePercentage: campaignData.affiliateFeePercentage.toString(),
