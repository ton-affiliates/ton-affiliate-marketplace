...
describe('AffiliateMarketplace Integration Test', () => {
    ...
    it('should create affiliate, sign by both parties, add funds, and handle user click', async () => {
        ...
        affiliateContractAddress && expect(createAffiliateResult.transactions).toHaveTransaction({
        ...
        const affiliateContract = blockchain.openContract(await Affiliate.fromInit(affiliateMarketplaceContract.address, 0n, advertiser.address, publisher.address, cpc));
